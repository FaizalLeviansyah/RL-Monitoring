        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-8">
            <div class="xl:col-span-2 p-6 bg-white border border-gray-200 rounded-2xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex gap-2">
                        <span class="flex items-center text-xs font-medium text-gray-500"><span class="w-2 h-2 rounded-full bg-blue-500 mr-1"></span> ASM</span>
                        <span class="flex items-center text-xs font-medium text-gray-500"><span class="w-2 h-2 rounded-full bg-yellow-400 mr-1"></span> ACS</span>
                        <span class="flex items-center text-xs font-medium text-gray-500"><span class="w-2 h-2 rounded-full bg-red-500 mr-1"></span> CTP</span>
                    </div>
                </div>
            ...
            <div class="p-6 bg-white border border-gray-200 rounded-2xl shadow-sm dark:bg-gray-800 dark:border-gray-700 flex flex-col h-full">
                    ...
                    <ul role="list" class="space-y-4">
                        ...
                        <li class="relative pl-6 border-l-2 border-gray-200 dark:border-gray-700 last:border-0 pb-4">
                            ...
                            <div class="flex flex-col">
                                ...
                                <span class="inline-block mt-0.5 text-[10px] px-1.5 py-0.5 rounded font-bold w-fit {{ $iconColor }}">
                                    {{ $compCode }}
                                </span>
                ...
                <div class="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700 text-center">
                    <a href="{{ route('admin.monitoring.index') }}" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">View Full History</a>
                </div>
            </div>
        </div>
    </div>
